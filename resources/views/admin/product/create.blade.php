                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('permission.index') }}" type="button" class="btn btn-outline-info btn-sm pull-right"><i class="fa fa-left-arrow"></i>&nbsp; Back To Permission List</a>
                        </div>
                    </div>
                    <div class="card-body">
                      <!-- Credit Card -->
                      <div id="pay-invoice">
                        ...
                        @endif
                              ...
                              {{ Form::open(array('url' => 'admin/product','method'=>'post', 'enctype'=>'multipart/form-data')) }}
