        ...
        <div class="container-fluid">
            ...
            <tr class="cart_item">
                ...
                <td class="product-thumbnail">
                    ...
                    <div class="cart-product__item">
                        <a href="#">
                            {{ $product->image }}
                            <img src="{{ asset('product') }}/{{ $product->model->thumb_image }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                        </a>
                ...
                <td class="product-price">
                    <h5 class="price amount">{{ $product->price }} BDT</h5>
                </td>
                ...
                <td class="product-quantity">
                    ...
                    <div class="quantity">
                        <a href="{{ route('cart.decr', ['id' => $product->rowId, 'qty' => $product->qty ]) }}" class="quantity-minus">-</a>
                              <input title="Qty" class="email input-text text" type="text" value="{{ $product->qty }}" placeholder="1" readonly>
            ...
            @endforeach
                            ...
                            <div class="cart-total">
                                ...
                                <h5 class="cart-total-total">Total: <span class="price">{{ Cart::total() }} BDT</span></h5>
